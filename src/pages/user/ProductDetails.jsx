  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen">
        {/* Reduced padding - Flipkart style compact layout */}
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 md:py-6">
          ...
          {/* Main Product Section - Reduced gap */}
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">

            {/* Left - Image Gallery with Flipkart-style slider */}
            <div className="space-y-3">
              {/* Main Image Container with Navigation Arrows - Flipkart style */}
              <div className="relative bg-gray-50 rounded-xl overflow-hidden group">
                
                {/* Navigation Arrows - Always visible on hover like Flipkart */}
                <button
                  onClick={() => paginate(-1)}
              ...
              {/* Thumbnails - Compact and scrollable like Flipkart */}
              ...
              {/* IMAGE PREVIEW MODAL with swipe support */}
              {showImagePreview && (
                <div className="fixed inset-0 z-[999] bg-black/95 backdrop-blur-xl flex items-center justify-center">
                  <button
                    onClick={() => setShowImagePreview(false)}
                    className="absolute top-4 right-4 z-50 bg-white/10 hover:bg-white/20 border border-white/10 p-2 rounded-full text-white transition"
                  >
                    <X size={22} />
                  </button>
                  ...
                  <button
                    onClick={() => paginate(-1)}
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-50 bg-white/10 hover:bg-white/20 rounded-full p-3 text-white transition"
                  >
                    <ChevronLeft size={28} />
                  </button>
                  ...
                  <button
                    onClick={() => paginate(1)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-50 bg-white/10 hover:bg-white/20 rounded-full p-3 text-white transition"
                  >
                  ...
                  <div className="w-full max-w-5xl px-4">
                    <AnimatePresence mode="wait">
                      <motion.img
                        ...
                        className="w-full max-h-[75vh] object-contain cursor-grab active:cursor-grabbing select-none touch-pan-y"
                      />
                    </AnimatePresence>
                      ...
                      {product.images.map((img, idx) => (
                        <button
                          ...
                          className={`w-12 h-12 rounded-lg overflow-hidden border-2 transition
                            ${currentImageIndex === idx ? "border-white scale-105" : "border-white/30"
                            }`}
                        >
            ...
            <div className="space-y-4">
              ...
              {/* Action Buttons - Compact but prominent */}
